...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            // Parsear el JWT sin verificar firma (Azure AD usa JWK público)
            // En producción usar JwkProvider para verificar firma con clave pública de Azure AD
            ...
            // Validar audience (client-id de Azure AD)
            ...
            // Extraer roles del token (claim 'roles' de Azure AD)
    ...
    // Separa header.payload del signature para parsear claims sin verificar firma local
